...
function BarChart(data, {
    ...
    const svg = d3.selectAll('#barplot').append("svg")
        .attr("width", width)
        .attr("height", height)
    ...
    const bar = svg.append("g")
      ...
      .join("rect")
        ...
        .on('mouseover', function() { return d3.select(this).attr('fill', 'green') })
        .on('mouseout', function() { return d3.select(this).attr('fill', 'steelblue') });
